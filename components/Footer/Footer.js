    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-icons">
          <a href="tel:775-555-5555"> <img src='/svg/phone.svg' alt="phone"/></a>
          <a href="mailto:airitsolutionsreno@gmail.com"> <img src='/svg/email.svg' alt="email"/></a>
          <a href="https://www.facebook.com/pg/nnnsllc/"
          rel="noopener noreferrer"
          target="_blank"> <img src='/svg/facebook.svg' alt="facebook"/></a>
        </div>
      </div>
    </footer>
  );
